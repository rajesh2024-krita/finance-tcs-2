...
export class LoanTakenComponent implements OnInit {
  ...
  getLoanTypeLimit(loanType: string): number {
    ...
    console.log('tabsObj == ', tabsObj);
    switch (loanType) {
      case 'General': return tabsObj.Limit.loan;
      case 'Emergency': return tabsObj.Limit.emergency;
      // case 'Festival': return tabsObj.Limit.festival;
      // case 'LAS': return tabsObj.Limit.las;
      // case 'LA FDR': return tabsObj.Limit.laFdr;
      default: return 0;
    }
  }
