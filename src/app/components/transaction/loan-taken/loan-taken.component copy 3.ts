    ...
    <div class="bg-gray-50 p-4 rounded-lg border">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div *ngIf="isCustom()">
          ...
          <select formControlName="customType" 
            class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="bg-gray-50 p-4 rounded-lg border">
        ...
        <div class="space-y-4">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">No. of Installments</label>
            <input type="number" readonly formControlName="installments" (input)="recalculate()" 
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="bg-gray-50 p-4 rounded-lg border">
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="bg-white p-3 rounded-lg border">
            <label class="block text-xs font-medium text-gray-500 mb-1">CD</label>
            <div class="text-lg font-semibold text-blue-700">{{formatCurrency(selectedMember?.cd ?? 0)}}</div>
          </div>
          <div class="bg-white p-3 rounded-lg border">
            <label class="block text-xs font-medium text-gray-500 mb-1">Last Salary</label>
            <div class="text-lg font-semibold text-blue-700">{{formatCurrency(selectedMember?.lastSalary ?? 0)}}</div>
          </div>
        </div>
        ...
        <div class="mt-4 pt-4 border-t border-gray-200">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="bg-white p-3 rounded-lg border">
              <label class="block text-xs font-medium text-gray-500 mb-1">CD</label>
              <div class="text-lg font-semibold text-green-600">{{formatCurrency(selectedMember?.cd ?? 0)}}</div>
            </div>
            
            <div class="bg-white p-3 rounded-lg border">
              <label class="block text-xs font-medium text-gray-500 mb-1">MWF</label>
              <div class="text-lg font-semibold text-green-600">{{selectedMember?.mwf ?? 0}}</div>
            </div>
            <div class="bg-white p-3 rounded-lg border">
        ...
        <div class="border rounded-lg overflow-hidden">
          <div class="flex border-b">
            ...
            <button type="button" (click)="activeTab='taken'" 
              [class]="'px-4 py-3 font-medium transition-colors ' + (activeTab==='taken' ? 'bg-indigo-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200')">
              Surety Taken
            </button>
          </div>
